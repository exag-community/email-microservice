...
type PagedRequest struct {
	...
	// The page size to return. Defaults to 10.
	PageSize int32 `protobuf:"varint,1,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	// The page is used to retrieve the next page of results. Defaults to 1.
	Page string `protobuf:"bytes,2,opt,name=page,proto3" json:"page,omitempty"`
	// The sort order to use. Defaults to "asc".
...
func (x *PagedRequest) GetPage() string {
	if x != nil {
		return x.Page
	}
	return ""
...
func (x *PagedRequest) GetSortOrder() string {
	if x != nil {
		return x.SortOrder
	}
	return ""
...
var file_common_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x22, 0x5e, 0x0a, 0x08, 0x47, 0x65, 0x6f, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x12,
	...
	0x65, 0x73, 0x73, 0x22, 0x5e, 0x0a, 0x0c, 0x50, 0x61, 0x67, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75,
	...
	0x70, 0x61, 0x67, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x6f, 0x72, 0x74, 0x5f, 0x6f, 0x72, 0x64,
...
var file_common_proto_goTypes = []interface{}{
	...
	(*GeoPoint)(nil),     // 11: common.GeoPoint
	(*PagedRequest)(nil), // 12: common.PagedRequest
}
