...
const (
	EmailService_SendMail_FullMethodName = "/email.EmailService/send_mail"
)
...
type EmailServiceClient interface {
	SendMail(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *emailServiceClient) SendMail(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, EmailService_SendMail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmailServiceServer interface {
	SendMail(context.Context, *SendMessageRequest) (*Empty, error)
...
func (UnimplementedEmailServiceServer) SendMail(context.Context, *SendMessageRequest) (*Empty, error) {
...
func _EmailService_SendMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmailService_SendMail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendMail(ctx, req.(*SendMessageRequest))
	}
