...
const (
	MailType_MAIL_TYPE_TEXT MailType = 0
	MailType_MAIL_TYPE_HTML MailType = 1
)
...
type SendMessageRequest struct {
	...
	Email    string   `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`                                            // email address of the recipient
	Subject  string   `protobuf:"bytes,2,opt,name=subject,proto3" json:"subject,omitempty"`                                        // subject of the email
	Body     string   `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`                                              // body of the email
	Embed    []byte   `protobuf:"bytes,4,opt,name=embed,proto3" json:"embed,omitempty"`                                            // base64 encoded image to embed in the email (optional)
	MailType MailType `protobuf:"varint,5,opt,name=mail_type,json=mailType,proto3,enum=email.MailType" json:"mail_type,omitempty"` // type of email to send
	Username string   `protobuf:"bytes,6,opt,name=username,proto3" json:"username,omitempty"`                                      // username of the recipient (optional)
}
...
func (x *SendMessageRequest) GetEmbed() []byte {
	if x != nil {
		return x.Embed
	}
	return nil
...
func (x *SendMessageRequest) GetMailType() MailType {
	if x != nil {
		return x.MailType
	}
	return MailType_MAIL_TYPE_TEXT
}
...
var file_email_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x69, 0x6c, 0x22, 0xb8, 0x01, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65,
	...
	,
...
var file_email_proto_goTypes = []interface{}{
	(MailType)(0),              // 0: email.MailType
	(*SendMessageRequest)(nil), // 1: email.SendMessageRequest
}
var file_email_proto_depIdxs = []int32{
	0, // 0: email.SendMessageRequest.mail_type:type_name -> email.MailType
